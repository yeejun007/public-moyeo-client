...
//     // const limit = 7
//     fetch(
//       `http://13.209.76.220:3000/rooms?region=${selected1}&category=${selected2}&limit=7&roomTitle=${searchValue}&roomId=${lastRoomId}`,
//       {
//         method: "GET"
//         // headers: {"x-access-token" : this.state.token},
//       }
...
//       this.state.rooms[this.state.rooms.length - 1].id !==
